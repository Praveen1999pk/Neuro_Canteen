...
import { loginDelivery } from '../api/auth';
import { Truck } from 'lucide-react-native';

import axiosInstance from '../api/axiosInstance';

export default function Handledeliverylogin() {
  ...
  const handleLogin = async () => {
    setLoading(true);
    const result = await loginDelivery(username, password);
    console.log(result)
    ...
    >
      ...
      >
        ...
        <View style={styles.form}>
          ...
          <Truck color="#0F5132" size={32} />
          <Text style={styles.deliveryTitle}>Delivery Login</Text>
        </View>
